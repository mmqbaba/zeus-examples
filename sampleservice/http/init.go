...
import (
	...
	// hello "zeus-examples/sampleservice/proto/gw"
)
...
func registerRoutesForHelloHandler(rootRouter *gin.RouterGroup, subGroup map[string]*gin.RouterGroup, addMWFn ...func(routes map[zeusmwhttp.RouteLink]*zeusmwhttp.Route)) {
	for _, f := range addMWFn {
		f(helloHdlrRoutes)
	}
	for _, r := range helloHdlrRoutes {
		zeusmwhttp.Method(rootRouter, subGroup, r)
	}
}
