...
// RegisterHelloHandlerFromEndpoint is same as RegisterHelloHandlerGW but
...
func RegisterHelloHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterHelloHandlerGW(ctx, mux, conn)
}

// RegisterHelloHandlerGW registers the http handlers for service Hello to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterHelloHandlerGW(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
