...
var _regex_GetMsgReq_CreateTime = regexp.MustCompile(`^[0-9]{4}-[0-9]{1,2}-[0-9]{1,2} [0-9]{2}:[0-9]{2}:[0-9]{2}$`)

func (this *GetMsgReq) Validate() error {
	if !_regex_GetMsgReq_CreateTime.MatchString(this.CreateTime) {
		return github_com_mwitkow_go_proto_validators.FieldError("CreateTime", fmt.Errorf(`value '%v' must be a string conforming to regex "^[0-9]{4}-[0-9]{1,2}-[0-9]{1,2} [0-9]{2}:[0-9]{2}:[0-9]{2}$"`, this.CreateTime))
	}
	if this.CreateTime == "" {
